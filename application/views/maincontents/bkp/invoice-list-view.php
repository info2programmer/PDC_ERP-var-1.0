<h4><i class="fa fa-plus-square-o"></i> Invoice List</h4>
<hr class="style5">
<div class="col-md-12">
...
<?php if($this->session->flashdata('error_message')) { echo $this->session->flashdata('error_message'); } ?>
  ...
  <h4><i class="fa fa-list-ul"></i> Invoice List</h4>
    ...
    <table width="1143" class="table table-hover">
      ...
      <?php if($rows) { $s=1; foreach($rows as $row) { ?>
        <tr>
          ...
          <td align="center" valign="middle">         
          <a target="_blank" href="<?php echo base_url();?>manage_book/preview_hotel_bill/<?php echo $row->room_book_id; ?>" title="Invoice Print"><i class="fa fa-print"></i></a>          </td>
        </tr>
      <?php } } else { ?>
      	<tr>
